...
/**
 */
public class TestJoinIndex
{
    private static final Logger log = new Logger(TestJoinIndex.class);
    ...
    public static final String[] USER_COLUMNS = new String[]{"ts", "userid", "categories", "index"};
    public static final String[] EVENT_COLUMNS = new String[]{"ts", "userid", "device", "os"};
    ...
    {
        final URL resource = TestJoinIndex.class.getClassLoader().getResource(resourceFilename);
